...
| [~] | Release v5.9.0 (merge→master, tag, publish package) | `Downloader.csproj` Version 5.9.0 + PackageReleaseNotes; tag `v5.9.0`; publish NuGet pkg to GitHub Packages (+ NuGet.org if key) | — |
